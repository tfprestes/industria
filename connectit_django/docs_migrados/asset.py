...
class Asset:
    ...
    def __init__(
        self,
        # --- Identificação e Classificação (Obrigatório) ---
        asset_type_id: str,
        brand: str,
        model: str,
        status: str,
        
        # --- Associação e Responsabilidade (Obrigatório) ---
        assigned_sector_id: str,
        assigned_unit_id: str,
        assigned_cost_center_id: str,
        
        # --- Dados Financeiros e Contrato (Obrigatório) ---
        lease_value: float,
        lease_date: Optional[datetime.datetime],

        # --- Campos Opcionais de Identificação e Gestão ---
        ...
        # --- Datas Opcionais do Ciclo de Vida ---
        ...
        # --- Campos de Especificações Técnicas (Opcionais) ---
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Converte o objeto Asset para um dicionário, adequado para ser salvo no Firestore."""
        asset_dict = self.__dict__.copy()
        asset_dict.pop('id', None)
        # Remove chaves com valor None para não salvar campos vazios no Firestore
    ...
    def from_dict(source: Dict[str, Any], id: str) -> "Asset":
        ...
        # por causa dos valores padrão na assinatura __init__
        # Usar **source passa todos os campos do dicionário como argumentos para o construtor
